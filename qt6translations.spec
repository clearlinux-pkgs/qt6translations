...
Version  : 6.9.0
Release  : 23
URL      : https://download.qt.io/official_releases/qt/6.9/6.9.0/submodules/qttranslations-everywhere-src-6.9.0.tar.xz
Source0  : https://download.qt.io/official_releases/qt/6.9/6.9.0/submodules/qttranslations-everywhere-src-6.9.0.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : BSD-3-Clause GPL-3.0
Requires: qt6translations-data = %{version}-%{release}
Requires: qt6translations-lib = %{version}-%{release}
...
%package lib
Summary: lib components for the qt6translations package.
Group: Libraries
Requires: qt6translations-data = %{version}-%{release}
Requires: qt6translations-license = %{version}-%{release}

%description lib
lib components for the qt6translations package.
...
%prep
%setup -q -n qttranslations-everywhere-src-6.9.0
cd %{_builddir}/qttranslations-everywhere-src-6.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743647062
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/qt6/sbom/qttranslations-6.9.0.spdx

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/qt6translations/8624bcdae55baeef00cd11d5dfcfa60f68710a02
/usr/share/package-licenses/qt6translations/b073f11f0c81a95ab5e32aa6b5d23a5955a95274
