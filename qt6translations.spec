...
Version  : 6.6.2
Release  : 12
URL      : https://download.qt.io/official_releases/qt/6.6/6.6.2/submodules/qttranslations-everywhere-src-6.6.2.tar.xz
Source0  : https://download.qt.io/official_releases/qt/6.6/6.6.2/submodules/qttranslations-everywhere-src-6.6.2.tar.xz
...
%prep
%setup -q -n qttranslations-everywhere-src-6.6.2
cd %{_builddir}/qttranslations-everywhere-src-6.6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708119951
mkdir -p clr-build
pushd clr-build
