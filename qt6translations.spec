...
Version  : 6.7.1
Release  : 14
URL      : https://download.qt.io/official_releases/qt/6.7/6.7.1/submodules/qttranslations-everywhere-src-6.7.1.zip
Source0  : https://download.qt.io/official_releases/qt/6.7/6.7.1/submodules/qttranslations-everywhere-src-6.7.1.zip
...
%prep
%setup -q -n qttranslations-everywhere-src-6.7.1
cd %{_builddir}/qttranslations-everywhere-src-6.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716951370
mkdir -p clr-build
pushd clr-build
