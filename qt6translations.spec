...
Source0  : https://download.qt.io/official_releases/qt/6.6/6.6.3/submodules/qttranslations-everywhere-src-6.6.3.tar.xz
...
%prep
%setup -q -n qttranslations-everywhere-src-6.6.3
cd %{_builddir}/qttranslations-everywhere-src-6.6.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711501995
mkdir -p clr-build
pushd clr-build
