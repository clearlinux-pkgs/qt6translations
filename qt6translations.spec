...
Version  : 6.8.0
Release  : 20
URL      : https://download.qt.io/official_releases/qt/6.8/6.8.0/submodules/qttranslations-everywhere-src-6.8.0.zip
Source0  : https://download.qt.io/official_releases/qt/6.8/6.8.0/submodules/qttranslations-everywhere-src-6.8.0.zip
...
%prep
%setup -q -n qttranslations-everywhere-src-6.8.0
cd %{_builddir}/qttranslations-everywhere-src-6.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732617965
mkdir -p clr-build
pushd clr-build
