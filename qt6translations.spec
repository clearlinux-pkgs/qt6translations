...
Source0  : https://download.qt.io/official_releases/qt/6.8/6.8.2/submodules/qttranslations-everywhere-src-6.8.2.zip
...
%prep
%setup -q -n qttranslations-everywhere-src-6.8.2
cd %{_builddir}/qttranslations-everywhere-src-6.8.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738709032
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/qt6/sbom/qttranslations-6.8.2.spdx
